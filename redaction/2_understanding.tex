...
%(find ref of that summer grad project where minsky wanted to assistants to solve language)

% add conclusion, quoting subsequent work of winogrand and language touch on flores and winograd
...
% then touch upon alternative conceptions of understanding with mccullough

% then wrap back up to wittgenstein with his philosophical investigations

% and then the conclusion of sicp, about understanding a program: turns out just formal notation is not sufficient to understand things beyond the realm of logic and arithmetic, and it is precisely in this beyond realm that computers now operate
