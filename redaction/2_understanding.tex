...
The concept of \emph{abstract artifact} therefore helps to clarify the tensions within software, and to locate the specific role of source code within the different moving parts of definition, medium and model. Nonetheless, this same concept points at a larger philosophical entanglement, that of computer science as a discipline and of technology as a concept.

\subsubsection{Philosophical investigations into software}

% conclusion of abstract artifact, moving to philosophy

As a result, software, as a part of the family of technical artefacts have \emph{functional} properties (purpose) and \emph{structural} ones (physical makeup which allow for the completion of the functional purpose) \citep{turner_computational_2018}
...
Now we shif the focus on technology in general, with Simondon expliciting an ambiguous status, between magic and philosophy.

software can be referred to as a the "dynamic of organized inorganic matter" (Stiegler 1998: 84).
...
% wrap up with 1k about the INTENT
...
\begin{quote}
    This suggests that, to understand software, we must understand intentions, purposes, goals, or will, which enlarges the problem far more than we originally anticipated. [...] We should not be surprised if human compositions that are meant to make machines do useful work should require us to posit and understand human purposiveness. After all, to distinguish *literature* from noise requires a similar undertaking. \citep{suber_what_1988}
\end{quote}
