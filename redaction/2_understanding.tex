...
We have based our discussion of understanding by defining it as the acquisition of the knowledge of a thing—be it a concept, a situation, an individual or an object,, which is accurate enough that it allows us to predict the behaviour and interact with such thing. Within this defintion, we take the example of a human discussion as a demonstration of advanced understanding.

Theories of how individuals acquire understanding (how they come to know things, and know conceptual representations of things), have been approached from an explicit perspective, and an implicit one. In the rationalist, logical philosophical tradition, we have seen that the belief that meaning (the communication of understanding) can be rendered unambiguous through the use of specific notation. This has led to the development of logic and computer science, as this meaning got mechanized. Explicit understanding is therefore the way of the computer.
...
As we've seen in the previous chapter, aesthetics in source code seem to be tightly coupled with the process of understanding source code. Before we dive deeper about how they do this explicitly in the following chapters, we now turn to what makes computation difficult to understand, and what are some general ways that humans engage in explicit and implicit means of understanding it.
