...
\begin{listing}
  \begin[fontsize=\footnotesize, breaklines, breakanywhere]{minted}{c}
...
\begin{listing}
  \begin[fontsize=\footnotesize]{minted}{c}
  no_more_data:
...
\begin{listing}
  \begin[linenos,firstnumber=663]{minted}{ca65}
  STODL  CG
  TTF/8
  DMP*  VXSC
...
\begin{listing}
  \begin[breaklines=true,breakanywhere]{minted}{text}
