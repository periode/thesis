...
This sections looks at architecture through its multiple aspects, to highlight to which extent some of these are reflected in source-code\footnote{Recall how, in \ref{subsubsec:craft-architecture}, programmers tended to refer extensively to themselves as architects.}. By investigating the tensions and overlaps of form, function, construction and materiality in the built space, we also identify similarities in the programmed space.
...
Then check the references  from philosophy of Architects
% \url{https://books.google.de/books/about/Philosophy_for_Architects.html?id=qUJ7KzsXpTsC&redir_esc=y}

cute, literally spatial code city:
%\url{https://wettel.github.io/codecity.html}
...
% Palladio and platonic form, the grammar of the facade, etc.
