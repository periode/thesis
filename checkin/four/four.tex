...
This section is about how models exist in both programming and literature, and how they're tied through knowledge and cognition, both within the text and in the broader sense

\subsection{In Software}

Start from  userland, metaphors also exist \url{https://issuu.com/instituteofnetworkcultures/docs/tod14-binnenwerk-def-pdf}, and also interface effect
...
the question of operational meaning (procedural) vs. denotational meaning (declarative) should be explored. what means what to the computer? -> highlight how we've seen that difference in source code poetry
...
This section shows how they are connected: that the metaphors work in software because they're not just within literature. The connection is that they are essentially \textbf{connections between mental models}.
...
Definitely a section onf : \emph{deep structure} vs. \emph{surface structure} (chomsky + detienne)
