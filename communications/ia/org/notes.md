...
- nature de la contribution des artistes (juste des œuvres en lignes? contribution vidéo supplémentaire?)
- confirmation du mail à envoyer aux contributeurs
- point sur les keynotes et chaires
- rapide discussion du site (et je peux vous faire faire un tour rapide de l'interface admin)

### 28.04

mettre en place et distribution des taches

comm (site web + email)

sessions (orga + emploi du temps + chaires)
...
- planifier sessions
  - 47 participants, (40 presentations, 7 createurs)
  - combien de sessions? 3 jours -> 4 sessions par jour, 12 sessions, environ 4 par session
  - qui sont les chaires?
  - quid d'une séparation par langue?
- coordonner les communiquants
  - quel format pour la publication? a priori ou a posteriori?
- site web?

IA thème / outil / partipant-productrice

## website

inspirations:

- [2021 space](https://2021space.iasc-commons.org/)
- [digital truth making](https://www2.hu-berlin.de/digitaltruthmaking/conference/)

- des sessions d'une heure max, des chairs différents pour chaque session
  - trouver les chaires pour chaque session
- des créneaux d'une heure vides entre presque chaque session
  - 30min-45min? -> go to wonder?
- certaines sessions avec les présentations enregistrées et mises en ligne pour écouter quelques jours avant, seule la discussion Q&A avec les auteures et l'audience est maintenue pendant l'heure live de la session, les présentations enregistrées sont ouvertes aux commentaires sur le site et resteront en ligne
  - **bonne idée** -> à quel point est-ce faisable? demander deux semaines avant?
  - il faudrait que chaque chaire soit entièrement enregistrée ou pas
- certaines sessions en live sans enregistrement des présentations en amont sur le mode talk on slides, c'était le cas pour des lancements de projet comme la déclaration des droits de la lune, et des thèmes moins académiques sur un format discussion panel
- 1h de networking/coffee break par jour sur [Wonder](https://www.wonder.me/) à des horaires différents chaque jour, dont l'une dédiée aux rencontres entre junior et seniors
  - autres activités?
- une playlist Spotify collaborative
  - **bonne idée** mais pas de compte spotify
- des channels de chat Slack
  - peut être plus actif qu'un chat zoom?
    - introductions
    - reading references
    - room 1/2/3
